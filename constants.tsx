...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const MergeIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const SplitIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const CompressIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const PptToPdfIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const WordToPdfIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const ExcelToPdfIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const JpgToPdfIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const SignIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const WatermarkIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const RotateIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const UnlockIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const LockClosedIcon = (): React.ReactElement => {
    return (
        <IconWrapper className="text-gray-500">
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const ProtectIcon = (): React.ReactElement => {
    return (
...
// FIX: Refactored to use a block body with an explicit return to avoid potential parser issues.
// FIX: Added explicit React.ReactElement return type to aid TypeScript inference.
export const PageNumbersIcon = (): React.ReactElement => {
    return (
...
export const EyeSlashIcon = (): React.ReactElement => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const RotateCcwIcon = (): React.ReactElement => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 group-hover:text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

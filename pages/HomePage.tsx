...
const tools = [
    ...
    { id: 'split', title: 'Split PDF', description: 'Extract pages from a PDF or save each page as a separate PDF.', icon: <SplitIcon />, category: 'Organize', disabled: false },
    { id: 'compress', title: 'Compress PDF', description: 'Reduce the file size of your PDF while optimizing for quality.', icon: <CompressIcon />, category: 'Optimize', disabled: false },
    { id: 'rotate', title: 'Rotate PDF', description: 'Rotate one or all pages in your PDF file as you need.', icon: <RotateIcon />, category: 'Organize', disabled: false },
    { id: 'jpg-to-pdf', title: 'JPG to PDF', description: 'Convert JPG, PNG, BMP, TIFF images to a PDF file.', icon: <JpgToPdfIcon />, category: 'Convert', disabled: false },
    { id: 'word-to-pdf', title: 'Word to PDF', description: 'Convert Microsoft Word documents to PDF format.', icon: <WordToPdfIcon />, category: 'Convert', disabled: false },
    { id: 'ppt-to-pdf', title: 'PowerPoint to PDF', description: 'Convert Microsoft PowerPoint presentations to PDF.', icon: <PptToPdfIcon />, category: 'Convert', disabled: false },
    { id: 'excel-to-pdf', title: 'Excel to PDF', description: 'Convert Microsoft Excel spreadsheets to PDF.', icon: <ExcelToPdfIcon />, category: 'Convert', disabled: false },
